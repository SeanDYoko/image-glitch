    ...
    return (
      <>
        ...
        <section>
          ...
          <p>
            This uses the
            <a href="https://github.com/Kentico/kontent-gatsby-packages/tree/master/packages/gatsby-kontent-components">
              ImageElement
            </a>
        ...
        >
          <section style={{ padding: "1em", maxWidth: showcaseWidth }}>
            ...
            />
            <p>
              This is the basic loading of the asset in full size and setting
              its width right in <tt>img</tt> tag (don't do that).
            </p>
          </section>
          <section style={{ padding: "1em", maxWidth: showcaseWidth }}>
            <img
